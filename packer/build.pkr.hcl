...
build {
  ...
  provisioner "shell" {
    inline = [
      ...
      "sudo gcloud config set project mando-host-project",
      "sudo gcloud secrets versions access 1  --secret=sam-cert --out-file=/etc/pki/ca-trust/source/anchors/sam.corp_CA.cer",
